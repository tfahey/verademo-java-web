								...
								<div>
									...
									<div class="commentText">
										...
										<span class="date sub-text">
											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %>by <%= ESAPI.encoder().encodeForHTMLAttribute(post.getAuthor().getBlabName()) %> on <%= post.getPostDateString() %>											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %>
										</span>
										<br/>
										<span class="date sub-text">
				...
				<div class="detailBox">
					...
					<div class="actionBox">
						...
						<ul class="commentList">
							...
							<li>
								<div class="commentText">
									<p class=""><%= post.getContent() %></p><p class=""><%= HtmlUtils.htmlEscape(post.getContent()) %></p>									<p class=""><%= post.getContent() %></p>
